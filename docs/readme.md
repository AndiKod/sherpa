...
Eventually the .md files from the collection would also land on something like Vercel & Netlify for mobile consumption or classic browser.

But that's almost another project along sh:erpa and Calepin.
The task is intersting, usefull but imense.



Hopefully, I'll get some support at some point.
